var canvas, ctx, gameControl, gameActive;
      ...
      const CANVAS_BACKGROUND_COLOUR = "#2C3539";
      const SNAKE_COLOUR = '#7D0541';
      ...
      function startGame(x) {
          ...
          gameActive = true;
          document.getElementById("game-status").innerHTML = "<small>C'est tipar !</small>";
      ...
      function pauseGame() {
          ...
          gameActive = false;
          document.getElementById("game-status").innerHTML = "<small>Pause</small>";
      }
      ...
      var snakeTrail = [];
      var snakeX = Math.floor((Math.random() * 10) + 1);
      var snakeY = Math.floor((Math.random() * 10) + 1);
